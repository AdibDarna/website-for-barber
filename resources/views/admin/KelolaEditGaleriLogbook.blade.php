                ...
                <div class="container-fluid">
                    <div class="card" ><!-- card utama -->
                        <div class="card-body">
                            ...
                            <div class="card card-warning"><!-- Card galeri logbook -->
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="/KelolaEditGaleriLogbook" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <input type="text" name="id" value="{{ $galeri_logbook->id }}" hidden>
                                            ...
                                            <div class="row"><!-- start row -->
                                                <div class="form-group col-md-6"><!-- row form kolom 1 kiri -->
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" value="{{ $galeri_logbook->nama_logbook }}" name="nama_logbook" class="form-control @error('nama_logbook') is-invalid @enderror">
                                                ...
                                                <div class="form-group col-md-6"><!-- row form kolom 1 kanan -->
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" name="gambar_logbook" class="custom-file-input form-control @error('gambar_logbook') is-invalid @enderror" id="customFile">
