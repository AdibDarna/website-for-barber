                ...
                <div class="container-fluid">
                    ...
                    <div class="card" ><!-- card utama -->
                        <div class="card-body"><!-- card body utama -->
                            ...
                            <div class="card card-warning"><!-- card galeri pelanggan -->
                                <div class="card-header">
                                    <h3 class="card-title">Edit Galeri Pelanggan</h3>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="/KelolaEditGaleriPengunjung" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <input type="text" name="id" value="{{ $galeri_pengunjung->id }}" hidden>
                                            ...
                                            <div class="row"><!-- start row -->
                                                <div class="form-group col-md-6"><!-- row form kolom 1 kiri -->
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" value="{{ $galeri_pengunjung->nama_gaya }}" name="nama_gaya" class="form-control @error('nama_gaya') is-invalid @enderror" placeholder="nama gaya cukur">
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6"><!-- row form kolom 2 kanan -->
                                                    <label style="color: gray;">Gambar Gaya Cukur</label>
                                                    <div class="custom-file">
                                                        <input type="file" name="gambar_gaya" class="custom-file-input form-control @error('gambar_gaya') is-invalid @enderror" id="customFile">
